...
class Body:
    def __init__(self) -> None:
        ...
        # Left arm
        self.joints["LH"] = Joint("LH",3, angmin=-1.4, angmax=1.4, min_val=165, max_val=170, invert=True)
        ...
        # Right arm
        self.joints["RH"] = Joint("RH",9, angmin=-1.4, angmax=1.4, min_val=165, max_val=170)
